...
<body>
    <table border="0" cellpadding="2" cellspacing="5" bgcolor="#eeeeee">
        ...
        <tr>
            ...
            in your form: <p><font color=red size=1><i>$fail</i></font></p></td>
        </tr>
        <form method="post" action="04_redisplaying_form_after_php_validation.php" onSubmit="return validate(this)">
            <tr>
                <td>Forename</td>
